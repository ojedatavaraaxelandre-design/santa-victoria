...
const STATS = [
  { val: '+5.000', label: 'Patients treated' },
...
export default function LandingPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#ffffff', fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div className="nav-links">
            {['Specialties', 'About', 'Contact'].map(link => (
              <a key={link}
          ...
          <div style={{ maxWidth: 640 }}>
            ...
            <div style={{
              ...
              <span style={{
                ...
                background: '#4A857A', display: 'inline-block',
            ...
            <h1 className="hero-title" style={{
              ...
              Your health,{' '}
              <span style={{ color: '#4A857A' }}>our</span>{' '}
              <span style={{ color: '#B89B72' }}>priority.</span>
            </h1>
            ...
            <p style={{
              ...
              Santa Victoria Medical Center — comprehensive care with modern technology,
              specialized physicians and real-time results.
            </p>
      ...
      {/* ── ESPECIALIDADES ── */}
      <section id="specialties" style={{ padding: '80px 24px', background: '#ffffff' }}>
      ...
      <section className="cta-section" style={{
        ...
        <div style={{ maxWidth: 600, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            Book your appointment in minutes. No queues, no unnecessary waiting.
          </p>
          <a href="/registro" style={{
